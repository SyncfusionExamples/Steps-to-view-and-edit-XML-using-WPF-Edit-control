...
This repository contains the samples that describes how to view and edit *.xml using WPF [EditControl](https://help.syncfusion.com/wpf/syntax-editor/getting-started)
